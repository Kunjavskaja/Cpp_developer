...
{
    std::cout << "This is ChatBot Constructor \n" << std::endl;
...
ChatBot::~ChatBot()
{
    std::cout << "This is ChatBot Destructor\n" << std::endl;
...
{
    std::cout << "This is Chatbot Copy Constructor\n" << std::endl;
    _image = new wxBitmap();
...
{
    std::cout << "This is Chatbot Copy Assignment\n" << std::endl;
...
{
    std::cout << "This is Chatbot Move Constructor\n" << std::endl;
...
{
    std::cout << " This is Chatbot Move Assignment\n" << std::endl;
